...
public class CustomArrayList<E> {
  ...
  /**
   * Ensure capacity of custom/your own ArrayList. Method increases capacity of
   * list by making it double.
   */
  ...
  /**
   * Display custom/your own ArrayList. Method displays all the elements in
   * list.
   */
  public void display() {
